...
import { ChevronLeft, ChevronRight, Marquee } from "@/components/atoms";
...
export default function Page() {
  ...
  const renderWomenImage = () => {
    if (getBreakpoint() === "xs" || getBreakpoint() === "sm") {
      return (
        <Image
          src="/img/mobile-women.webp"
          alt="Product Categories for women"
        />
      );
    }

    return <Image src="/img/women.webp" alt="Product Categories for women" />;
  };

  const renderMenImage = () => {
    if (getBreakpoint() === "xs" || getBreakpoint() === "sm") {
      return (
        <Image src="/img/mobile-men.webp" alt="Product Categories for men" />
      );
    }

    return <Image src="/img/men.webp" alt="Product Categories for men" />;
  };
      ...
      <div id="appContainer" className="bg-noise-white relative z-0">
        <div className="app-container relative flex max-h-[768px] min-h-screen flex-col items-center justify-center overflow-hidden md:h-screen md:min-h-[unset]">
          <Fade cascade triggerOnce duration={1000} direction="up">
            ...
            <Link href="/products">
              <button className="btn tooltip px-8" type="button">
                <span>Shop Now</span>
          ...
          <Image
            src="/img/hero_1.jpg"
            alt="Hero"
            className="Image-animation-load hero-image absolute left-[5%] bottom-[5%] z-[1] w-full max-w-[100px] sm:left-[10%] sm:bottom-[10%] sm:max-w-[125px] md:left-[15%] md:max-w-[175px] lg:left-[20%]"
            ref={HeroImage1Ref}
          />
          <Image
            src="/img/hero_2.jpg"
            alt="Hero"
            className="Image-animation-load hero-image absolute right-[-15%] top-[10%] z-[1] w-full max-w-[125px] sm:right-[5%] sm:top-[10%] sm:max-w-[150px] md:max-w-[240px] lg:right-[15%]"
            ref={HeroImage2Ref}
            style={{
              animationDelay: "1s",
            }}
          ...
          <Image
            src="/img/hero_3.jpg"
            alt="Hero"
            className="Image-animation-load hero-image absolute -left-[5%] top-[10%] z-[2] w-full max-w-[100px] sm:left-0 sm:top-[30%] sm:max-w-[125px] md:left-[5%] md:max-w-[225px] lg:left-[10%]"
            ref={HeroImage3Ref}
            style={{
              animationDelay: "1.5s",
            }}
