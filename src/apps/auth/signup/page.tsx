...
import { Lock, User, Miolica, Mail } from "@/components/atoms";
    ...
    <div className="signup bg-noise-white h-screen overflow-y-hidden">
      <Fade cascade triggerOnce duration={1500}>
        ...
        >
          ...
          <label className="mt-5 flex w-3/5 items-center justify-start text-custom-black-700">
            <input
              type="checkbox"
              name="checkbox"
              id="checkbox"
